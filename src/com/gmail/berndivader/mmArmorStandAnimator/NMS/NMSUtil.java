...
public class NMSUtil {
    ...
    static
    {
        ...
        try {
            ...
            class_EntityProjectile = NMSUtil.getBukkitClass("net.minecraft.server.EntityProjectile");
            class_EntityFireball = NMSUtil.getBukkitClass("net.minecraft.server.EntityFireball");
    ...
    public static boolean hasMeta(ItemStack stack, String tag) {
        if (NMSUtil.isEmpty(stack)) return false;
    ...
    public static Object getNode(ItemStack stack, String tag) {
        if (NMSUtil.isEmpty(stack)) return null;
        Object meta = null;
        try {
    ...
    public static void removeMeta(ItemStack stack, String tag) {
        if (NMSUtil.isEmpty(stack)) return;
    ...
    public static boolean getMetaBoolean(ItemStack stack, String tag, boolean defaultValue) {
        if (NMSUtil.isEmpty(stack)) return defaultValue;
